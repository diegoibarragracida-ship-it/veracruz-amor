  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post(`${API}/prestadores/register`, {
        ...form,
        documentos: form.documentos.map(d => d.path),
      });
      setSuccess(true);
    } catch (err) {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe tu negocio, servicios ofrecidos, especialidades..."
                    rows={4}
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        value={form.horarios}
                        onChange={(e) => updateForm("horarios", e.target.value)}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateForm("nombre_contacto", e.target.value)}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) => updateForm("email_contacto", e.target.value)}
            ...
            <div className="space-y-6" data-testid="step-3">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Sube los documentos que acrediten tu negocio (licencias, permisos, certificados, etc.)
                </p>
              </div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-[#1B5E20] transition-colors">
                ...
                <label htmlFor="file-upload" className="cursor-pointer">
                  ...
                  <p className="text-gray-700 font-medium">
                    {uploadingFile ? "Subiendo archivo..." : "Haz clic para subir documentos"}
                  </p>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <span className="font-medium">{form.tipo}{form.subtipo ? ` - ${form.subtipo}` : ""}</span>
                  <span className="text-gray-500">Responsable:</span>
                  <span className="font-medium">{form.nombre_contacto}</span>
                  <span className="text-gray-500">Email:</span>
                  <span className="font-medium">{form.email_contacto}</span>
                  <span className="text-gray-500">Teléfono:</span>
                  <span className="font-medium">{form.telefono}</span>
                  <span className="text-gray-500">Documentos:</span>
                  <span className="font-medium">{form.documentos.length} archivo(s)</span>
                </div>
              </div>
